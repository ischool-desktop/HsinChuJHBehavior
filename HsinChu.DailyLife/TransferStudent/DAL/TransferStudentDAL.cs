...
namespace HsinChu.DailyLife.TransferStudent.DAL
{
    public static class TransferStudentDAL
    {
        ...
        public static void Save(TransferStudentData transferStudentData, string studentid)
        {
            ...
            if (insertIndex > 1)
            {
                DSAServices.CallService("SmartSchool.Score.InsertSemesterMoralScore", new DSRequest(insertHelper.BaseElement));
            }
            if (updateIndex > 1)
            {
                DSAServices.CallService("SmartSchool.Score.UpdateSemesterMoralScore", new DSRequest(updateHelper.BaseElement));
            }
        }
    }
}
